  ...
  return (
    <>
      <div className={appSt.container}>
        ...
        <div className={appSt.grid}>
          <a
            ...
            onClick={() => window.gtag('event', 'Alfapotok_3531_3')}
          >
            <div>
          ...
          <a
            ...
            onClick={() => window.gtag('event', 'DFA_3')}
          >
            <div>
              <Typography.Text view="primary-medium" tag="p" defaultMargins={false} weight="medium">
                ЦФА
          ...
          <a
            ...
            onClick={() => window.gtag('event', 'Fonds_3')}
          >
            <div>
              <Typography.Text view="primary-medium" tag="p" defaultMargins={false} weight="medium">
                Фонды
          ...
          <a
            ...
            onClick={() => window.gtag('event', 'DU_3')}
          >
            <div>
              <Typography.Text view="primary-medium" tag="p" defaultMargins={false} weight="medium">
                ДУ
          ...
          <a
            ...
            onClick={() => window.gtag('event', 'IIS_3')}
          >
            <div>
              <Typography.Text view="primary-medium" tag="p" defaultMargins={false} weight="medium">
                ИИС
      ...
      <div className={appSt.bottomBtn}>
        <ButtonMobile block view="primary" href="alfabank://investments" onClick={() => window.gtag('event', 'Vitrina_3')}>
          Витрина инвестиций
        </ButtonMobile>
      </div>
      <BottomSheet
        ...
        onClose={() => {
          if (selectedItem === 'isz') {
            window.gtag('event', 'ISG_Exit_3');
          } else {
            window.gtag('event', 'NSG_Exit_3');
          }
          setOpenBs(false);
        }}
        hasCloser
        ...
        actionButton={
          <ButtonMobile
            ...
            onClick={() => {
              if (selectedItem === 'isz') {
                window.gtag('event', 'ISG_More_info_3');
              } else {
                window.gtag('event', 'NSG_More_info_3');
              }
            }}
          >
            Подробнее на сайте
      ...
      >
        <div className={appSt.containerBS}>
          ...
          <Typography.Title
            ...
            onClick={() => {
              if (selectedItem === 'isz') {
                window.gtag('event', 'ISG_Mobile_3');
              } else {
                window.gtag('event', 'NSG_Mobile_3');
              }
